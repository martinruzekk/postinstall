...
sudo apt update
sudo apt install zsh zsh-autosuggestions zsh-syntax-highlighting git sshfs google-chrome-stable virtualbox apt-transport-https apache2 python3 php7.4 php7.4-bcmath python-is-python3 neofetch cowsay sl fortune htop ulauncher brave-browser ubuntu-restricted-extras snap thunderbird wine64 ttf-mscorefonts-installer vlc ffmpeg openshot-qt gimp docker docker-compose nodejs -y
