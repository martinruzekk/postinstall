...
sudo apt update
sudo apt install zsh zsh-autosuggestions zsh-syntax-highlighting git sshfs virtualbox apt-transport-https apache2 python3 php7.4 php7.4-bcmath python-is-python3 neofetch cowsay sl htop ulauncher ubuntu-restricted-extras snap thunderbird wine64 ttf-mscorefonts-installer vlc ffmpeg gimp docker docker-compose nodejs -y
